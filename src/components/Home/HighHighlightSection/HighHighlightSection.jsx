import HighHighlightItem from './HighHighlightItem'
...
export const HighHighlightSection = () => {
  return (
    <section className="bg-gray-50 lg:bg-purple-50 flex flex-col p-5 lg:px-[100px]">
      <h2 className="font-bold leading-[24px] tracking-[0.75px] sm:text-2xl sm:leading-[38px] py-2.5">Coleções em destaque</h2>
