    ...
    <section>
        <div className="font-Inter">
          <div className="flex flex-col bg-white rounded lg:pb-10  pb-8 mb-[10px] lg:mb[18px] ">
            <div className="flex">
              <p className="bg-[#E7FF86] mt-5 ml-5 px-3 rounded-[30px] text-center text-xs font-bold py-2">{produto.desconto * 100}% OFF</p>
            </div>
          ...
          <p className="text-dark-gray-2 font-medium md:font-normal text-sm md:text-2xl">{produto.marca} {produto.nome} - {produto.sexo}</p>
          <div className="flex">
