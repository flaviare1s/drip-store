...
export const FeaturedProductList = () => {
  ...
  return (
    <div className="text-Inter px-5 md:px-[100px] bg-light-gray-3 md:bg-purple-50 md:pb-[120px] pb-10">
      <div className="flex justify-between mb-5 items-center">
        <h1 className="font-bold md:text-2xl">Produtos em alta</h1>
        <a
          className="text-primary font-semibold md:font-normal text-sm md:text-lg tracking-[.75px]"
          href="#"
        >
          Ver todos
        </a>
